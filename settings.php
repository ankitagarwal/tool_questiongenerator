...
// TODO
//$ADMIN->add('reports', new admin_externalpage('questiongenerator', get_string('pluginname', 'tool_questiongenerator'),
//    "$CFG->wwwroot/$CFG->admin/tool/questiongenerator/index.php", 'tool/questiongenerator:generatequestions'));
